...
<a href="https://github.com/santi-bnt">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=21&duration=2800&pause=900&color=00D9FF&center=true&vCenter=true&width=760&lines=Robotics+%26+Intelligent+Systems+Engineering+Student;Embedded+Systems+%7C+Hardware+Integration+%7C+Software;ESP32+%2B+KL25Z+%2B+Raspberry+Pi;C+%2F%2F+C%2B%2B+%2F%2F+Python" alt="Typing intro" />
</a>
...
I am a Robotics and Intelligent Systems Engineering student at Tecnológico de Monterrey, interested in embedded systems, robotics, hardware integration, and software development.

I enjoy building projects that combine microcontrollers, sensors, communication protocols, databases, and real-time interfaces.

Currently, I am improving my skills in data structures, algorithms, object-oriented programming, and backend-oriented software development.
...
### SkiliAir — Air Quality Monitoring System
...
**Technologies:** Python, Flask, MySQL, Raspberry Pi, GPIO, Chart.js

---

### MATT — Web-Controlled Writing Robot

Web-controlled robot system using Firebase, ESP32, UART communication, and an embedded KL25Z controller.

**Technologies:** ESP32, Firebase, UART, C/C++, JavaScript
...
Academic projects involving classes, inheritance, polymorphism, file handling, matrices, and fractions.

**Technologies:** C++, OOP, UML, File I/O
